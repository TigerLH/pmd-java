  ...
  extends AbstractJavaRule
{
  ...
  private static final StringMultiProperty TYPES_DESCRIPTOR = new StringMultiProperty("types", "Affected types", new String[] { "android.database.Cursor" }, 2.0F, ',');
  ...
  private void checkForCursor(Node node, Object data)
  {
